@extends('user.layout')
@section('title','Sent Messages | LEmail')
@section('stylesheets')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="top-right" style="float: right">
                                    ...
                                    <a href="{{ url('sent/message') }}" class="btn social-btn btn-social-outline-facebook"><i class="mdi mdi-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            let csrf = "{{ csrf_token() }}";
            let url = "{{ url('delete/sender/message/') }}";
